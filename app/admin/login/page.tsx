...
export const metadata: Metadata = {
  title: "Acesso Administrativo | Alexandra Fonseca",
};
    ...
    <div className="min-h-screen flex flex-col bg-navy relative overflow-hidden">
      ...
      <div className="relative flex flex-col flex-1 items-center justify-center px-6 py-16">
        ...
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
          <h1 className="font-display font-bold text-2xl mb-1">Acesso administrativo</h1>
          <p className="text-sm text-[#8493ab] mb-6">
            Área reservada à gestão do estúdio.
          </p>
          <LoginForm portal="admin" googleEnabled={false} redirectTo="/admin" />
        </div>
      </div>
    </div>
  );
